...
int.Admissions <- Admissions$Research * get_transformed_df(Admissions, c("Chance.of.Admit", "Research"), function(x) x, "int.Research")
...
# Probar con un mutation rate más bajo, por más generaciones, y variando el tamaño de la población!!
